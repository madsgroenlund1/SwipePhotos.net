                  ...
                  {[
                    {
                      ...
                      svg: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="white"><path d="M11.5 2C9.2 5.2 8 8 8.5 10.5c.3 1.5 1.1 2.8 2.2 3.8-.2-.8-.1-1.6.3-2.3.8-1.5 2.3-2 2.3-2S12 11.8 12.8 13c.6.9.8 2 .5 3-.3 1-1 1.8-2 2.2 1.7.3 3.4-.3 4.5-1.5 1.3-1.4 1.8-3.3 1.5-5.2-.2-1.2-.7-2.3-1.5-3.2.2 1-.1 2.1-.8 2.8-.3-2.7-1.8-5-3.5-9.1z"/></svg>
                    },
                    {
