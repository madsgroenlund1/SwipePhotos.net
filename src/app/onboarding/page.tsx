                  ...
                  {[
                    {
                      ...
                      svg: <svg viewBox="0 0 32 32" className="w-5 h-5" fill="white"><path d="M16 2c-1 2.5-2 5-1.5 7.5.3 1.5 1 2.8 2 3.8-.1-.7 0-1.4.4-2 .7-1.2 1.6-1.6 1.6-1.6s-.8 1.8-.2 3.3c.5 1.2 1.5 2 1.2 3.5-.3 1.5-1.2 2.5-2.5 2.8 2 .2 3.8-.8 4.8-2.5 1.2-2 1.2-4.5 0-6.5.3 1-.1 2.2-.8 2.8C21 10.5 19.5 7.5 16 2z"/></svg>
                    },
                    {
                      // Hinge — H shape
                      pos: '-top-3 -right-4', label: '99+', delay: '0.4s', bg: 'bg-[#E8504A]',
                      svg: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="white"><rect x="4" y="3" width="4" height="18" rx="2"/><rect x="16" y="3" width="4" height="18" rx="2"/><rect x="4" y="10" width="16" height="4" rx="2"/></svg>
                    },
                    {
                      // Instagram — camera
                    ...
                    },
                    {
                      ...
                      svg: <svg viewBox="0 0 24 24" className="w-5 h-5" fill="white"><path d="M6 3h7c2.2 0 4 1.8 4 4 0 1-.4 2-1 2.7C17.2 10.5 18 11.8 18 13.5 18 16 16 18 13.5 18H6V3zm3 3v3h3.5c.8 0 1.5-.7 1.5-1.5S13.3 6 12.5 6H9zm0 6v3h4c.8 0 1.5-.7 1.5-1.5S13.8 9 13 9H9z"/></svg>
                    },
