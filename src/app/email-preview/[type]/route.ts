...
const hr = `<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0;border-collapse:collapse;"><tr><td style="border-top:1px solid rgba(10,10,10,0.07);font-size:0;line-height:0;">&nbsp;</td></tr></table>`
...
const TEMPLATES: Record<string, string> = {
  ...
  'order-confirmed': base(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:36px;">
      <tr><td style="padding:14px 16px;background-color:#f7f8fa;border:1px solid rgba(10,10,10,0.07);border-bottom:none;border-radius:14px 14px 0 0;">
      ...
      <tr><td style="padding:14px 16px;background-color:#f7f8fa;border-left:1px solid rgba(10,10,10,0.07);border-right:1px solid rgba(10,10,10,0.07);border-bottom:none;">
        <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;"><tr>
          <td width="28" style="vertical-align:middle;"><table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;"><tr><td width="28" height="28" style="background-color:#1c1c1e;border:1px solid rgba(10,10,10,0.07);border-radius:50%;text-align:center;vertical-align:middle;font-family:${FONT};font-size:12px;font-weight:700;color:#52525b;line-height:26px;">2</td></tr></table></td>
      ...
      <tr><td style="padding:14px 16px;background-color:#f7f8fa;border:1px solid rgba(10,10,10,0.07);border-top:none;border-radius:0 0 14px 14px;">
        <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;width:100%;"><tr>
  ...
  'photos-ready': base(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:32px;"><tr><td style="background-color:#f7f8fa;border:1px solid rgba(59,130,246,0.18);border-radius:16px;padding:28px 24px;text-align:center;">
  ...
  'offer-accepted': base(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:32px;"><tr><td style="background-color:#f7f8fa;border:1px solid rgba(37,99,235,0.18);border-radius:16px;padding:20px 24px;text-align:center;"><p style="margin:0;font-family:${FONT};font-size:13px;color:${TEXT_SEC};line-height:1.8;">Your subscription continues without interruption.<br/>Keep getting fresh AI photos every month.</p></td></tr></table>
  ...
  'affiliate-application': base(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:32px;"><tr><td style="background-color:#f7f8fa;border:1px solid rgba(10,10,10,0.07);border-radius:16px;padding:24px 22px;">
  ...
  'affiliate-approved': base(
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;margin-bottom:28px;"><tr><td style="background-color:#f7f8fa;border:1px solid rgba(37,99,235,0.25);border-radius:16px;padding:20px 22px;">
