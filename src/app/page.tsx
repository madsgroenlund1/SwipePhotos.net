        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white/[0.03] border border-white/8 rounded-2xl overflow-hidden">
            <div className="flex h-72 relative">
              ...
              <div className="relative flex-1 overflow-hidden">
                <Image src="/photos/before-after/andreas/after/1.jpg" alt="Andreas after" fill className="object-cover" style={{ objectPosition: 'center 5%' }} sizes="(max-width: 768px) 50vw, 33vw" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <span className="absolute bottom-2 left-2 text-green-400 text-[10px] font-bold uppercase tracking-wide bg-black/40 px-1.5 py-0.5 rounded">✓ After</span>
              </div>
            </div>
          ...
          <div className="bg-white/[0.03] border border-white/8 rounded-2xl overflow-hidden">
            <div className="flex h-72 relative">
              ...
              <div className="relative flex-1 overflow-hidden">
                <Image src="/photos/before-after/julius/after/1.jpg" alt="Julius after" fill className="object-cover" style={{ objectPosition: 'center 3%' }} sizes="(max-width: 768px) 50vw, 33vw" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <span className="absolute bottom-2 left-2 text-green-400 text-[10px] font-bold uppercase tracking-wide bg-black/40 px-1.5 py-0.5 rounded">✓ After</span>
              </div>
            </div>
