      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 ml-auto md:ml-0">
          <a href="https://www.instagram.com/swipephotosnet/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
            className="w-8 h-8 rounded-lg overflow-hidden flex items-center justify-center hover:scale-105 transition-transform"
            style={{ background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)' }}>
            <svg className="w-4.5 h-4.5 text-white" style={{ width: 18, height: 18 }} fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <a href="https://www.tiktok.com/@cardsnap.app" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
            className="w-8 h-8 rounded-lg bg-black border border-white/15 flex items-center justify-center hover:scale-105 transition-transform">
            <svg style={{ width: 18, height: 18 }} viewBox="0 0 24 24" aria-hidden>
              {/* TikTok brand mark: cyan + red offset layers under the white glyph */}
